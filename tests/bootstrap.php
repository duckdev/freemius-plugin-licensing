 ...
 * test in {@see \DuckDev\Freemius\Tests\TestCase}.
 *
...
// Source files all guard with `defined( 'WPINC' ) || die;` — define
// it here so the files can be loaded by the autoloader during tests.
if ( ! defined( 'WPINC' ) ) {
